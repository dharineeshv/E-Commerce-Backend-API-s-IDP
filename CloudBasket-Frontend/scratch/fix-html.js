...
// Find the index of <div class="header-right"> or similar stable point
const rightIdx = content.indexOf('<div class="header-right">');
if (rightIdx === -1) {
    // If it's missing, find profile-section
    const profileIdx = content.indexOf('<div class="profile-section">');
    content = content.substring(profileIdx);
} else {
    content = content.substring(rightIdx);
}
...
fs.writeFileSync(path, newHeader + content);
