...
async function fetchCartData() {
    ...
    try {
        const response = await fetch("https://5g4locecl2.execute-api.ap-southeast-1.amazonaws.com/api/v1/cart", {
            headers: {
...
async function fetchWishlistData() {
    ...
    try {
        const response = await fetch(`https://5g4locecl2.execute-api.ap-southeast-1.amazonaws.com/api/v1/wishlist/${customerId}`, {
            headers: {
                "Authorization": `Bearer ${token}`,
                "Content-Type": "application/json"
            }
    ...
    // 6. Available Coupons & Discounts
        ...
        try {
            const marketingEndpoint = (window.API && window.API.marketingService) 
                ...
                : 'https://5g4locecl2.execute-api.ap-southeast-1.amazonaws.com/api/v1/marketing/coupons';
